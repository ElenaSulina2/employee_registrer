...
- В проекте все эндпоинты и бизнес-логика осознанно реализованы с использованием синхронных функций, в пользу надежности. При развитии проекта возможен переход на асинхонный вариант.
